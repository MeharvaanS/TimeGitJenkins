...
class TimeTest {
    ...
    void testGetMillisecondsBad() {
    	int milliseconds = Time.getMilliseconds("10:00");
    	assertEquals(-1, milliseconds);
    }
    
    @ParameterizedTest
    @ValueSource(strings = {"00:00:00:00", "12:34:56:56", "23:59:59:59"})
    void testGetMilliSecondsBoundary(String time) {
        int expectedMilliseconds = Time.getMilliseconds(time);
